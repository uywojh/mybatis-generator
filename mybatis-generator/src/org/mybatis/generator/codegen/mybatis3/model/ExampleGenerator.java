...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        topLevelClass.addImportedType("com.yimama.core.query.ABaseDaoFilter");
        String shortName = type.getShortName();
        System.out.println(shortName);
        topLevelClass.setSuperClass("ABaseDaoFilter<"+shortName+".Criteria>");
        topLevelClass.setVisibility(JavaVisibility.PUBLIC);
        commentGenerator.addJavaFileComment(topLevelClass);
        commentGenerator.addClassComment(topLevelClass, introspectedTable, " mapper 操作过滤器");
        ...
        method.setName("getScalarExistedCriteria");
        method.addBodyLine("if(oredCriteria!=null && oredCriteria.size()>0){"); //$NON-NLS-1$
        method.addBodyLine("	return oredCriteria.get(0);"); //$NON-NLS-1$
        method.addBodyLine("}"); //$NON-NLS-1$
        method.addBodyLine("return or();"); //$NON-NLS-1$
