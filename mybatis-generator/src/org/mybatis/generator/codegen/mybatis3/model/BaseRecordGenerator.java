...
//        topLevelClass.addFileCommentLine(introspectedTable.getRemark());
        
        if(introspectedTable.hasXuidColumn() && introspectedTable.hasColumn("id")){
        	topLevelClass.addImportedType("com.alibaba.fastjson.annotation.JSONType");
        	topLevelClass.addAnnotation("@JSONType(ignores = { \"id\" })");
        } 
