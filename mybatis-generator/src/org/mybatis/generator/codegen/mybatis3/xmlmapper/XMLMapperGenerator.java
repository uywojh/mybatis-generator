...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.DeleteByXuidElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByXuidElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectScalarByExampleWithBLOBsElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectScalarByExampleWithoutBLOBsElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.UpdateByXuidSelectiveElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.UpdateByXuidWithBLOBsElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.UpdateByXuidWithoutBLOBsElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addSelectScalarByExampleWithBLOBsElement(answer);
        addSelectScalarByExampleWithoutBLOBsElement(answer);
        ...
        if(introspectedTable.hasXuidColumn()){
	        addSelectByXuidElement(answer);
	        addDeleteByXuidElement(answer);
	        addUpdateByXuidSelectiveElement(answer);
	        addUpdateByXuidWithBLOBsElement(answer);
	        addUpdateByXuidWithoutBLOBsElement(answer);
        }
    ...
    protected void addSelectScalarByExampleWithoutBLOBsElement(
            XmlElement parentElement) {
        if (introspectedTable.getRules().generateSelectScalarByExampleWithoutBLOBs()) {
            AbstractXmlElementGenerator elementGenerator = new SelectScalarByExampleWithoutBLOBsElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }

    protected void addSelectScalarByExampleWithBLOBsElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateSelectScalarByExampleWithBLOBs()) {
            AbstractXmlElementGenerator elementGenerator = new SelectScalarByExampleWithBLOBsElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
    ...
    protected void addSelectByXuidElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateSelectByXuid()) {
            AbstractXmlElementGenerator elementGenerator = new SelectByXuidElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
    ...
    protected void addDeleteByXuidElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateDeleteByXuid()) {
            AbstractXmlElementGenerator elementGenerator = new DeleteByXuidElementGenerator(false);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
    ...
    protected void addUpdateByXuidSelectiveElement(
            XmlElement parentElement) {
        if (introspectedTable.getRules().generateUpdateByXuidSelective()) {
            AbstractXmlElementGenerator elementGenerator = new UpdateByXuidSelectiveElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
    ...
    protected void addUpdateByXuidWithBLOBsElement(
            XmlElement parentElement) {
        if (introspectedTable.getRules().generateUpdateByXuidWithBLOBs()) {
            AbstractXmlElementGenerator elementGenerator = new UpdateByXuidWithBLOBsElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
    ...
    protected void addUpdateByXuidWithoutBLOBsElement(
            XmlElement parentElement) {
        if (introspectedTable.getRules()
                .generateUpdateByXuidWithoutBLOBs()) {
            AbstractXmlElementGenerator elementGenerator = new UpdateByXuidWithoutBLOBsElementGenerator(false);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
