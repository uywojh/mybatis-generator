 ...
 * 
 */
public class ProviderSelectScalarByExampleWithoutBLOBsMethodGenerator extends
        AbstractJavaProviderMethodGenerator {

    public ProviderSelectScalarByExampleWithoutBLOBsMethodGenerator() {
        super();
    }
    ...
    public boolean callPlugins(Method method, TopLevelClass topLevelClass) {
        return context.getPlugins().providerSelectScalarByExampleWithoutBLOBsMethodGenerated(method, topLevelClass,
                introspectedTable);
    }
}
