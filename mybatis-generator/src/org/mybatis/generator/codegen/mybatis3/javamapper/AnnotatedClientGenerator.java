...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.annotated.AnnotatedSelectScalarByExampleWithBLOBsMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.annotated.AnnotatedSelectScalarByExampleWithoutBLOBsMethodGenerator;
...
public class AnnotatedClientGenerator extends JavaMapperGenerator {
    ...
    protected void addSelectScalarByExampleWithBLOBsMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateSelectScalarByExampleWithBLOBs()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new AnnotatedSelectScalarByExampleWithBLOBsMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    ...
    protected void addSelectScalarByExampleWithoutBLOBsMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateSelectScalarByExampleWithoutBLOBs()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new AnnotatedSelectScalarByExampleWithoutBLOBsMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
