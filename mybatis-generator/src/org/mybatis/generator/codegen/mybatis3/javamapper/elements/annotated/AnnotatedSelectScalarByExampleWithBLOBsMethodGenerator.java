 ...
 * @author Jeff Butler
 */
public class AnnotatedSelectScalarByExampleWithBLOBsMethodGenerator extends
    SelectByExampleWithBLOBsMethodGenerator {

    public AnnotatedSelectScalarByExampleWithBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getSelectScalarByExampleWithBLOBsStatementId());
        sb.append("\")"); //$NON-NLS-1$
