...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_DELETE_BY_XUID_STATEMENT_ID,
        ...
        ATTR_SELECT_SCALAR_BY_EXAMPLE_STATEMENT_ID,
        ATTR_SELECT_SCALAR_BY_EXAMPLE_WITH_BLOBS_STATEMENT_ID, 
        
        ATTR_SELECT_BY_PRIMARY_KEY_STATEMENT_ID,
        ATTR_SELECT_BY_XUID_STATEMENT_ID,
        ...
        ATTR_UPDATE_BY_XUID_STATEMENT_ID,
        ATTR_UPDATE_BY_XUID_SELECTIVE_STATEMENT_ID,
        ATTR_UPDATE_BY_XUID_WITH_BLOBS_STATEMENT_ID,
...
//    private String xuidColumn = "xuid";
    private String xuidColumnName;
    ...
    public String getXuidColumnName() {
		return xuidColumnName;
	}

	public void setXuidColumnName(String xuidColumn) {
		this.xuidColumnName = xuidColumn;
	}
	
	IntrospectedColumn xuidColumnV;
	
	 public IntrospectedColumn getXuidColumn() {
		 if(xuidColumnV == null && xuidColumnName != null){
			 xuidColumnV = getColumn(xuidColumnName);
		 }
		 return xuidColumnV;
	}
    ...
    public String getSelectScalarByExampleQueryId() {
        return tableConfiguration.getSelectScalarByExampleQueryId();
    }
    ...
    public String getSelectByXuidQueryId() {
        return tableConfiguration.getSelectByXuidQueryId();
    }
    ...
    public List<IntrospectedColumn> getNonXuidColumns() {
    	//no primary key and xuid column
        List<IntrospectedColumn> answer = new ArrayList<IntrospectedColumn>();
        if(baseColumns != null && baseColumns.size()>0){
            for(IntrospectedColumn c : baseColumns){
            	if(c!=null && !c.getActualColumnName().equalsIgnoreCase("xuid")){
            		answer.add(c);
            	}
            }
        }
    ...
    public String getXuidType() {
        return internalAttributes.get(InternalAttribute.ATTR_XUID_TYPE);
    }
    ...
    public void addColumn(IntrospectedColumn introspectedColumn) {
        ...
        //XUID
        if(introspectedColumn.getActualColumnName().equalsIgnoreCase(this.context.getXuidName())){
        	this.setXuidColumnName(introspectedColumn.getActualColumnName());
        	this.xuidColumnV = introspectedColumn;
        	this.setCheckedXuid(true);
        }
    ...
    protected void calculateXmlAttributes() {
        ...
        setDeleteByXuidStatementId("deleteByXuid"); //$NON-NLS-1$
        setInsertStatementId("insert"); //$NON-NLS-1$
        setInsertSelectiveStatementId("insertSelective"); //$NON-NLS-1$
        setSelectAllStatementId("selectAll"); //$NON-NLS-1$
        setSelectByExampleStatementId("selectByExample"); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId("selectByExampleWithBLOBs"); //$NON-NLS-1$
        setSelectScalarByExampleStatementId("selectScalarByExample"); //$NON-NLS-1$
        setSelectScalarByExampleWithBLOBsStatementId("selectScalarByExampleWithBLOBs"); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId("selectByPrimaryKey"); //$NON-NLS-1$
        setSelectByXuidStatementId("selectByXuid"); //$NON-NLS-1$
        ...
        setUpdateByXuidStatementId("updateByXuid"); //$NON-NLS-1$
        setUpdateByPrimaryKeySelectiveStatementId("updateByPrimaryKeySelective"); //$NON-NLS-1$
        setUpdateByXuidSelectiveStatementId("updateByXuidSelective"); //$NON-NLS-1$
        setUpdateByPrimaryKeyWithBLOBsStatementId("updateByPrimaryKeyWithBLOBs"); //$NON-NLS-1$
        setUpdateByXuidWithBLOBsStatementId("updateByXuidWithBLOBs"); //$NON-NLS-1$
    ...
    public void setUpdateByXuidWithBLOBsStatementId(String s) {
        internalAttributes
                .put(
                        InternalAttribute.ATTR_UPDATE_BY_XUID_WITH_BLOBS_STATEMENT_ID,
                        s);
    }
    ...
    public void setUpdateByXuidSelectiveStatementId(String s) {
        internalAttributes
                .put(
                        InternalAttribute.ATTR_UPDATE_BY_XUID_SELECTIVE_STATEMENT_ID,
                        s);
    }
    ...
    public void setUpdateByXuidStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_UPDATE_BY_XUID_STATEMENT_ID, s);
    }
    ...
    public void setSelectByXuidStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SELECT_BY_XUID_STATEMENT_ID, s);
    }
    ...
    public void setSelectScalarByExampleWithBLOBsStatementId(String s) {
        internalAttributes
                .put(
                        InternalAttribute.ATTR_SELECT_SCALAR_BY_EXAMPLE_WITH_BLOBS_STATEMENT_ID,
                        s);
    }
    ...
    public void setSelectScalarByExampleStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SELECT_SCALAR_BY_EXAMPLE_STATEMENT_ID, s);
    }
    ...
    public void setDeleteByXuidStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_DELETE_BY_XUID_STATEMENT_ID, s);
    }
    ...
    public String getUpdateByXuidWithBLOBsStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_UPDATE_BY_XUID_WITH_BLOBS_STATEMENT_ID);
    }
    ...
    public String getUpdateByXuidSelectiveStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_UPDATE_BY_XUID_SELECTIVE_STATEMENT_ID);
    }
    ...
    public String getUpdateByXuidStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_UPDATE_BY_XUID_STATEMENT_ID);
    }
    ...
    public String getSelectByXuidStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_BY_XUID_STATEMENT_ID);
    }
    ...
    public String getSelectScalarByExampleWithBLOBsStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_SCALAR_BY_EXAMPLE_WITH_BLOBS_STATEMENT_ID);
    }
    ...
    public String getSelectScalarByExampleStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_SCALAR_BY_EXAMPLE_STATEMENT_ID);
    }
    ...
    public String getDeleteByXuidStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_DELETE_BY_XUID_STATEMENT_ID);
    }
    ...
    protected void calculateModelAttributes() {
        ...
        if(this.hasXuidColumn()){
            this.setXuidType(String.class.getName());
        }
    ...
    public void setXuidType(String xuidType) {
        internalAttributes.put(InternalAttribute.ATTR_XUID_TYPE,
                xuidType);
    }
	...
	private boolean checkedXuid = false;

	public void setCheckedXuid(boolean checkedXuid) {
		this.checkedXuid = checkedXuid;
	}

	public boolean isCheckedXuid() {
		return checkedXuid;
	}

 
	public boolean hasXuidColumn() {
		return this.getXuidColumnName()!=null;
	}
	...
	public boolean hasColumn(String colName) { 
		...
		if(primaryKeyColumns!=null && primaryKeyColumns.size()>0){
			for(IntrospectedColumn col : primaryKeyColumns){
				if(col.getActualColumnName().equalsIgnoreCase(colName)){
					return true;
				}
			}
		}
