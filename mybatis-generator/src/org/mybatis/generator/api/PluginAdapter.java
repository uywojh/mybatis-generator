...
public abstract class PluginAdapter implements Plugin {
    ...
    protected boolean hasXuid(Context context, IntrospectedTable introspectedTable){
//    	if(!introspectedTable.isCheckedXuid()){
//    		boolean f = false;
//    	   	List<IntrospectedColumn> cols = introspectedTable.getAllColumns();
//        	if(cols != null && cols.size()>0){
//        		for(IntrospectedColumn col : cols){
//        			if(col.getActualColumnName().equalsIgnoreCase("xuid")){
//        				f = true;
//        				break;
//        			}
//        		}
//        	}
//        	introspectedTable.setHasXuidColumn(f);
//        	introspectedTable.setCheckedXuid(true);
//    	}
        return introspectedTable.hasXuidColumn();
    }
    ...
    public boolean clientDeleteByXuidMethodGenerated(Method method,
            Interface interfaze, IntrospectedTable introspectedTable) {
        return this.hasXuid(context, introspectedTable);
    }
    ...
    public boolean modelXuidClassGenerated(TopLevelClass topLevelClass,
            IntrospectedTable introspectedTable) {
        return this.hasXuid(context, introspectedTable);
    }
...
//    public boolean sqlMapSelectScalarByXuidWithoutBLOBsElementGenerated(
//            XmlElement element, IntrospectedTable introspectedTable) {
//        return this.hasXuid(context, introspectedTable);
//    }
//
//    public boolean sqlMapSelectScalarByXuidWithBLOBsElementGenerated(
//            XmlElement element, IntrospectedTable introspectedTable) {
//        return this.hasXuid(context, introspectedTable);
//    }
