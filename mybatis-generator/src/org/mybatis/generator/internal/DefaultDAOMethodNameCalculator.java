...
public class DefaultDAOMethodNameCalculator implements DAOMethodNameCalculator {
    ...
    public String getSelectScalarByExampleWithoutBLOBsMethodName(
            IntrospectedTable introspectedTable) {
        Rules rules = introspectedTable.getRules();

        if (!rules.generateSelectScalarByExampleWithBLOBs()) {
            return "selectScalarByExample"; //$NON-NLS-1$
        } else {
            return "selectScalarByExampleWithoutBLOBs"; //$NON-NLS-1$
        }
    }
    ...
    public String getSelectScalarByExampleWithBLOBsMethodName(
            IntrospectedTable introspectedTable) {
        Rules rules = introspectedTable.getRules();

        if (!rules.generateSelectScalarByExampleWithoutBLOBs()) {
            return "selectScalarByExample"; //$NON-NLS-1$
        } else {
            return "selectScalarByExampleWithBLOBs"; //$NON-NLS-1$
        }
    }
