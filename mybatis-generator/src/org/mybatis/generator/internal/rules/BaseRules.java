...
public abstract class BaseRules implements Rules {
    ...
    public boolean generateUpdateByXuidWithoutBLOBs() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isUpdateByXuidStatementEnabled()
                && introspectedTable.hasXuidColumn()
                && introspectedTable.hasBaseColumns();
    ...
    public boolean generateUpdateByXuidWithBLOBs() {
        if (isModelOnly) {
            return false;
        }
    ...
    public boolean generateUpdateByXuidSelective() {
        if (isModelOnly) {
            return false;
        }
    ...
    public boolean generateDeleteByXuid() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isDeleteByXuidStatementEnabled()
                && introspectedTable.hasXuidColumn();
    ...
    public boolean generateBaseResultMap() {
        ...
        boolean rc = tableConfiguration.isSelectByExampleStatementEnabled()
        		|| tableConfiguration.isSelectScalarByExampleStatementEnabled()
    ...
    public boolean generateSelectByXuid() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isSelectByXuidStatementEnabled()
                && introspectedTable.hasXuidColumn()
                && (introspectedTable.hasBaseColumns() || introspectedTable
                        .hasBLOBColumns());
    ...
    public boolean generateSelectScalarByExampleWithoutBLOBs() {
        if (isModelOnly) {
            return false;
        }
        
        return tableConfiguration.isSelectScalarByExampleStatementEnabled();
    }
    
    public boolean generateSelectScalarByExampleWithBLOBs() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isSelectScalarByExampleStatementEnabled()
                && introspectedTable.hasBLOBColumns();
