...
public interface Rules {
    ...
    boolean generateSelectScalarByExampleWithoutBLOBs();
    /**
    ...
    boolean generateSelectScalarByExampleWithBLOBs();
    ...
    boolean generateUpdateByXuidWithoutBLOBs();
    
    boolean generateUpdateByXuidWithBLOBs();   
    
    boolean generateUpdateByXuidSelective();
    
    boolean generateDeleteByXuid();
}
