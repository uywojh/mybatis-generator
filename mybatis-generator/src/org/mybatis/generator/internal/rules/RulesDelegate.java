...
public class RulesDelegate implements Rules {
    ...
    public boolean generateDeleteByXuid() {
        return rules.generateDeleteByXuid();
    }
    ...
    public boolean generateXuidClass() {
        return rules.generateXuidClass();
    }
    ...
    public boolean generateSelectByXuid() {
        return rules.generateSelectByXuid();
    }
    ...
    public boolean generateUpdateByXuidSelective() {
        return rules.generateUpdateByXuidSelective();
    }

    public boolean generateUpdateByXuidWithBLOBs() {
        return rules.generateUpdateByXuidWithBLOBs();
    }

    public boolean generateUpdateByXuidWithoutBLOBs() {
        return rules.generateUpdateByXuidWithoutBLOBs();
    }
