...
public class TableConfiguration extends PropertyHolder {
    ...
    private boolean selectByXuidStatementEnabled;

    public boolean isSelectByXuidStatementEnabled() {
		return selectByXuidStatementEnabled;
	}

	public void setSelectByXuidStatementEnabled(boolean selectByXuidStatementEnabled) {
		this.selectByXuidStatementEnabled = selectByXuidStatementEnabled;
	}


	private boolean selectByExampleStatementEnabled;
    
    private boolean selectScalarByExampleStatementEnabled;

    public boolean isSelectScalarByExampleStatementEnabled() {
		return selectScalarByExampleStatementEnabled;
	}

	public void setSelectScalarByExampleStatementEnabled(boolean selectScalarByExampleStatementEnabled) {
		this.selectScalarByExampleStatementEnabled = selectScalarByExampleStatementEnabled;
	}
	...
	private boolean updateByXuidStatementEnabled;
 

    public boolean isUpdateByXuidStatementEnabled() {
		return updateByXuidStatementEnabled;
	}

	public void setUpdateByXuidStatementEnabled(boolean updateByXuidStatementEnabled) {
		this.updateByXuidStatementEnabled = updateByXuidStatementEnabled;
	}



	private boolean deleteByXuidStatementEnabled;
    
    public boolean isDeleteByXuidStatementEnabled() {
		return deleteByXuidStatementEnabled;
	}

	public void setDeleteByXuidStatementEnabled(boolean deleteByXuidStatementEnabled) {
		this.deleteByXuidStatementEnabled = deleteByXuidStatementEnabled;
	}
    ...
    private String selectByXuidQueryId;

    public String getSelectByXuidQueryId() {
		return selectByXuidQueryId;
	}

	public void setSelectByXuidQueryId(String selectByXuidQueryId) {
		this.selectByXuidQueryId = selectByXuidQueryId;
	}


	private String selectByExampleQueryId;
    private String selectScalarByExampleQueryId; 
	...
	public void setXuidColumnName(String xuidColumnName) {
		this.xuidColumnName = xuidColumnName;
	}
	...
	public TableConfiguration(Context context) {
        ...
        selectScalarByExampleStatementEnabled = true; 
        selectByXuidStatementEnabled = true;
        updateByXuidStatementEnabled = true;
        deleteByXuidStatementEnabled = true;
    ...
    public String getSelectScalarByExampleQueryId() {
		return selectScalarByExampleQueryId;
	}

	public void setSelectScalarByExampleQueryId(String selectScalarByExampleQueryId) {
		this.selectScalarByExampleQueryId = selectScalarByExampleQueryId;
	}
    ...
    public boolean areAnyStatementsEnabled() {
        return selectByExampleStatementEnabled || selectScalarByExampleStatementEnabled
    ...
    public XmlElement toXmlElement() {
        ...
        if (!selectByXuidStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableSelectByXuid", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        ...
        if (!selectScalarByExampleStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableSelectScalarByExample", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }           
        ...
        if (!updateByXuidStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableUpdateByXuid", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        ...
        if (!deleteByXuidStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableDeleteByXuid", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        ...
        if (stringHasValue(selectByXuidQueryId)) {
            xmlElement.addAttribute(new Attribute(
                    "selectByXuidQueryId", selectByXuidQueryId)); //$NON-NLS-1$
        }
        ...
        if (stringHasValue(selectScalarByExampleQueryId)) {
            xmlElement.addAttribute(new Attribute(
                    "selectScalarByExampleQueryId", selectScalarByExampleQueryId)); //$NON-NLS-1$
        }
    ...
    public void validate(List<String> errors, int listPosition) {
        ...
        if (isTrue(getProperty(PropertyRegistry.TABLE_USE_COLUMN_INDEXES))) {
            ...
            // should be set
            if (selectByExampleStatementEnabled
            		&& selectScalarByExampleStatementEnabled
                    && selectByPrimaryKeyStatementEnabled) {
                boolean queryId1Set = stringHasValue(selectByExampleQueryId);
                boolean queryId2Set = stringHasValue(selectScalarByExampleQueryId);
                boolean queryId3Set = stringHasValue(selectByXuidQueryId);
                boolean queryId4Set = stringHasValue(selectByPrimaryKeyQueryId);

                if (queryId1Set != queryId3Set) {
