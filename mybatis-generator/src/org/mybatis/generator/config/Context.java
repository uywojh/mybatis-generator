...
public class Context extends PropertyHolder {
    ...
    private String xuidName = "xuid";

    public String getXuidName() {
		return xuidName;
	}

	public void setXuidName(String xuidName) {
		this.xuidName = xuidName;
	}
